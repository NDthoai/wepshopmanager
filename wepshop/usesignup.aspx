<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="usesignup.aspx.cs" Inherits="wepshop.usesignup" %>
                 ...
                 <div class="row">
                  <div class="row">
                     <div class="col-8">
                        <center>
                           <div class="form-group ">                 
                              <asp:Button class="btn btn-success btn-block btn-sm" ID="btnSignUp" runat="server" Text="Sign Up" Width="500px"/>
                           </div>
                        </center>
                     </div>
                  </div>
